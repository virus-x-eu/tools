...
parser.add_argument("--size-limit", dest='size_limit', type=int, default=0, required=False, help='Files are only downloaded if the SRA file size (not FASTQ) in bytes is below this limit.')
...
if args.size_limit == 0 or data['sra_bytes'][0] < args.size_limit:
